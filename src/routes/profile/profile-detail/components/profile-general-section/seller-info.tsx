        ...
        <Container className="px-0">
          ...
          <div>
            ...
            <div className="px-8 py-4 flex">
              ...
              <Text className="w-1/2">
                {companyTypeMap[metadata?.basic?.companyType! as keyof typeof companyTypeMap] || '-'}
              </Text>
            </div>
            <Divider />
            <div className="px-8 py-4 flex">
            ...
            <div className="px-8 py-4 flex">
              ...
              <Text className="w-1/2">
                {metadata?.business?.exportExperience
                  ? exportExperienceMap[metadata?.business?.exportExperience as keyof typeof exportExperienceMap]
                  : '-'}
              </Text>
            </div>
            <Divider />
